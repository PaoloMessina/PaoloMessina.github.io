...
CREATE OR REPLACE VIEW public.vw_sanzioni_accessorie
AS SELECT dsa.fk_seq_id_violazione, string_agg(dsa.desc_sanzione::text, ', '::text) AS desc_sanzione_accessoria
FROM d_sanzioni_accessorie dsa
group by dsa.fk_seq_id_violazione;
 


-- public.vw_lista_adi source
CREATE OR REPLACE VIEW public.vw_lista_adi
AS SELECT dadi.seq_id_adi,
dadi.codice_adi,
dadi.matricola,
